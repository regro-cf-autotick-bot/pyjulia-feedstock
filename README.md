...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyjulia-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15208&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyjulia-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyjulia` can be installed with:

```
conda install pyjulia
```

It is possible to list all of the versions of `pyjulia` available on your platform with:
